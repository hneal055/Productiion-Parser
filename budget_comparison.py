...
def create_comparison_charts(budgets, comparison, output_dir):
    ...
    total_path = os.path.join(output_dir, "budget_total_comparison.png")
    ...
    if shared_depts:
        ...
        dept_path = os.path.join(output_dir, "department_comparison.png")
    ...
    if shared_depts:
        ...
        pct_path = os.path.join(output_dir, "percentage_comparison.png")
